...
(function ($, _) {
    ...
    */
    ...
    if (window.i18n === undefined) {
        ...
        // dependencies slim
        i18n.init({
            resStore: SirTrevor.Locales,
            fallbackLng: SirTrevor.LANGUAGE,
            ns: {
    ...
    */
    ...
    SirTrevor.BlockMixins.Ajaxable = {
        ...
        removeQueuedItem: function (name) {
            ...
            this._queued = _.reject(this._queued, function (queued) {
        ...
        _handleDrop: function (e) {
            ...
            */
            ...
            if (!_.isUndefined(types) &&
                _.some(types, function (type) {
                    return _.include(this.valid_drop_file_types, type);
                }, this)) {
    ...
    SirTrevor.BlockHiding = (function () {

        var BlockHiding = function (block) {
            this.block = block;
        ...
        _.extend(BlockHiding.prototype, FunctionBind, Renderable, {
            bound: ['onClick'],

            tagName: 'a',
            className: 'st-block-ui-btn st-block-ui-btn--hide icon-lock',
            ...
            onClick: function (e) {
                e.preventDefault();
                this.block.blockStorage.commented = !this.block.blockStorage.commented;
                this.changeClass();
            },

            changeClass: function () {
                if (this.block.blockStorage.commented) {
                    this.block.$el.addClass('sir-commented-block');
                } else {
                    this.block.$el.removeClass('sir-commented-block');
                }
            },
    ...
    SirTrevor.BlockStore = {
        ...
        createStore: function (blockData, commented) {
            this.blockStorage = {
    ...
    SirTrevor.SimpleBlock = (function () {
        ...
        var SimpleBlock = function (data, instance_id, commented) {
            this.createStore(data, commented);
        ...
        _.extend(Block.prototype, SirTrevor.SimpleBlock.fn, SirTrevor.BlockValidations, {
            ...
            */
            ...
            _initUIComponents: function () {
                ...
                if (window.isPage) {
                    this._withUIComponent(
                        new SirTrevor.BlockHiding(this)
                    );
                }
    ...
    */
    ...
    SirTrevor.Blocks.Heading3 = SirTrevor.Block.extend({
        ...
        title: function () {
            return i18n.t('blocks:heading3:title');
        },
    ...
    SirTrevor.Blocks.Heading4 = SirTrevor.Block.extend({
        ...
        title: function () {
            return i18n.t('blocks:heading4:title');
        },
    ...
    */
    ...
    SirTrevor.Editor = (function () {
        ...
        _.extend(SirTrevorEditor.prototype, FunctionBind, SirTrevor.Events, {
            ...
            build: function () {
                ...
                if (store.data.length > 0) {
                    _.each(store.data, function (block) {
                        ...
                        this.createBlock(block.type, block.data, block.commented);
                    }, this);
            ...
            */
            createBlock: function (type, data, commented) {
                type = _.classify(type);
                ...
                var block = new SirTrevor.Blocks[type](data, this.ID, commented);
            ...
            */
            ...
            findBlockById: function (block_id) {
                return _.find(this.blocks, function (b) {
                    return b.blockID == block_id;
                });
            },

            getBlocksByType: function (block_type) {
                return _.filter(this.blocks, function (b) {
                    return _.classify(b.type) == block_type;
                });
            },

            getBlocksByIDs: function (block_ids) {
                return _.filter(this.blocks, function (b) {
                    return _.contains(block_ids, b.blockID);
                });
            },
            ...
            */
            _getBlockTypeLimit: function (t) {
                if (!this._isBlockTypeAvailable(t)) {
                    return 0;
                }
